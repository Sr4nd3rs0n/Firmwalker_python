...
################### Functions that uses find command ###################
'''
def sslfiles(firmdir, sslfiles_dictionary):
    print("€€€€€€€€€€€€€€€€€€€€ Search for SSL related files €€€€€€€€€€€€€€€€€€€€\n")
    for value in sslfiles_dictionary:
        certvar = []
        print(f"€€€€€€€€€€€€€€€€€€€€ {value} €€€€€€€€€€€€€€€€€€€€\n")
        certvar.append(find_UNIX_function(firmdir, value))
...
def print_path(firmdir, filename = None, output_format = None):
    if output_format == 'txt' or output_format == 'pdf':
        fl = open(filename, 'a')
        #fl = open(filename+output_format, 'a')
...
def webservers(firmdir, webservers_dictionary, filename = None, output_format = None):
    #print("Prueba: {}".format(output_format))
    if output_format == 'txt' or output_format == 'pdf':
        fl = open(filename, 'a')        
        #fl = open(filename+output_format, 'a')
...
def binwalk_execution(binary_name, filename, output_format = None):
    ...
    if output_format == 'txt':
        ...
        fl.write("««««««««««««««««««««««««««««»»»»»»»»»»»»»»»»»»»»»»»»»»»»\n\n")
        fl.close()
        #print("This is middle: {}".format(middle))
...
def analysis(firmdir, full_dictionary, dic_regex, filename = None, output_format = None):
    ...
    for key in full_dictionary:
    	if key == 'passfiles':
    		...
    		#print("This is the firmdir for .sh: {}".format(firmdir))
    ...
    #print("DICT_REGEX: {}".format(dic_regex))
    for value in dic_regex:
    	#print("value: {}".format(dic_regex[value]))p
